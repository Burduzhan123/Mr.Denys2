...
console.log((+null == false) < 1) //Ответ False. 0 тоже самое, что и фолс. После превращения с помощью двух = , будет тру ибо значения одинаковы. А так как там ТРУ(это отличимые от нуля числа)то ТРУ не будет меньше 1, а так же потому, что там в начале +(который исключает число меньше единицы)//
...
console.log((+null == false) < 1 ** 5)//ответ false// по аналогии с 35//